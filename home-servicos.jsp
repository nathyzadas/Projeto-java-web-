...
<head>
    ...
    <title>Serviços | FourBarber</title>
    ...
    <div class="content-body">
        ...
        <div class="display-f align-c w-100 content-card-content">
            ...
            try {
                ...
                out.println("Existe: " + listaServico.size() + " serviços cadastrados");

                for (Servico linha : listaServico) {
            %>
            <div class="card-pag animate_card">
                <img src="./uploads/<%= linha.getFotoServico() %>">
                <div class="content-card">
                    <div class="t-center f-kanit f-900 f-20 upper m-b"><%= linha.getNomeServico() %></div>
                    <div class="t-center f-mont f-200 f-14">
                        <p><%= linha.getDescServico() %></p>
                    </div>
                    
                    <br>
    <br>
                    <!-- Botão de Encomenda -->
                    <a href="http://localhost:8080/fourBarber/login.jsp"<%= linha.getNomeServico() %>"
                        class="btn-encomenda">
                        Agendar
                    </a>
                </div>
            ...
            <%
                ...
                out.println("Erro ao listar os serviços: " + e.getMessage());
            }
            %>
        </div>
    </div>
