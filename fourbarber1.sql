...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Ago-2023 às 16:48
...
CREATE TABLE `tbagenda` (
  `idAgenda` int(11) NOT NULL,
  `dataAgenda` varchar(10) DEFAULT NULL,
  `horaAgenda` varchar(5) DEFAULT NULL,
  `nomeServico` varchar(100) NOT NULL,
...
INSERT INTO `tbagenda` (`idAgenda`, `dataAgenda`, `horaAgenda`, `nomeServico`, `nomeFuncionario`, `nomeCliente`, `idCliente`, `idServico`) VALUES
(19, '08/08/2023', '10:10', '123123123', 'juliana', 'thhrhrt', 23, 20);
...
(1, 'juliana@gmail.com', 'jknjnjnk'),
(5, 'wan@gmail.com', 'kbkjbjkkj'),
(6, '', ''),
(7, 'juliana@gmail.com', 'kjnnnlnl'),
(8, 'juliana@gmail.com', 'kjhuhuhhuho'),
(9, 'wan@gmail.com', 'kbhbbkjkkjiunjkiu');
...
(26, 'bdfbdfbdf', 'fbbdbdfbdfb', 'ab.jpg');
