	...
	<main class="content">
		<section class="area-a">
			<div class="background f-kanit f-900 f-24">
				<p class="title animation">Todo dia é dia para dar um trato no
					visual .</p>
				...
				<div class="form">
					<form action="ValidarCliente" method="post">
						...
						<label class="f-mont f-500 f-18">Email</label> <input
							...
							placeholder="Digite o seu nome de usuário" name="txtLogin"
						...
						<ul></ul>
						<p>
							Não é cadastrado? <a href="cadastra-login.jsp">Cadastre-se aqui</a>.
						</p>
					</form>
				</div>
			</div>
